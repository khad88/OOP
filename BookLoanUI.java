...
//        // Tạo JScrollPane và JTable
        ...
        //Lable
        JLabel jlReaderId = new JLabel ("Mã độc giả");
        JLabel jlBookId = new JLabel ("Mã Sách");
        JLabel jlrReturn = new JLabel ("Ngày hẹn trả");
	...
	df = new SimpleDateFormat("yyyy-MM-dd");
        ...
        //setup vị trí
        jlReaderId.setBounds(65, 70, 100, 20);
        jlBookId.setBounds(65, 120, 100, 20);
        jlrReturn.setBounds(65, 170, 148, 20);
	...
	lblOutputBook.setBounds(175, 100, 221, 20);
        ...
        jbReaderCheck.setBounds(323, 70, 90, 21);
        jbBookIdcheck.setBounds(323, 120, 90, 20);
        ...
        //add
        pnlLoan.add(jlReaderId);
        pnlLoan.add(jlBookId);
        pnlLoan.add(jlrReturn);
